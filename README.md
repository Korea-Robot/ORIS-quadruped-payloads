...
#### 3.2. 온디바이스 자율주행 솔루션
Nav2 기반의 자율주행 솔루션입니다. 본 솔루션은 Nvidia AGX Orin 기반의 온디바이스 보드에서 실행되며, 온디바이스 보드에서 추론을 수행하는 것을 목표로 합니다.
사용 방법은 [AV_gz_sim](./AV_gz_sim) 디렉토리를 참고하세요.

#### 3.3. 카메라 임무장비 API 서버
Gremsy 카메라를 원격으로 활용하기 위한 서버 솔루션입니다. 본 솔루션은 Nvidia AGX Orin 기반의 온디바이스 보드에서 실행되며, 온디바이스 보드에서 취득한 이미지 정보를 외부로 송출하는 역할을 합니다.
사용 방법은 [camera_api](./camera_api) 디렉토리를 참고하세요.
